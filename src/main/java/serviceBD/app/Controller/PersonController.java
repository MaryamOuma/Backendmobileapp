...
public class PersonController {
    ...
    public boolean checkLogin(@PathVariable(value = "tel") String login) {
    	System.out.println(login + " " +personService.loginExists(login));
